define([
    ...
    CreditDisplay.prototype.addCredit = function(credit) {
        ...
        if (credit._isIon) {
            ...
            if (defined(screenCredits[cesiumCredit.id])) {
                screenCredits[cesiumCredit.id] = credit;
            } else {
    ...
    CreditDisplay.prototype.beginFrame = function() {
        ...
        if (defined(cesiumCredit)) {
            this._currentFrameCredits.screenCredits[cesiumCredit.id] = cesiumCredit;
        }
    };
